...
<Project Type="Project" LVVersion="11008008">
	...
	<Item Name="RT CompactRIO Target" Type="RT CompactRIO">
		...
		<Property Name="alias.value" Type="Str">10.9.7.2</Property>
		<Property Name="CCSymbols" Type="Str">OS,VxWorks;CPU,PowerPC;PIDimplementation,G;TARGET_TYPE,RT;</Property>
...
KeepAliveTimeout 60
		...
		<Item Name="TypeDefs" Type="Folder">
			<Item Name="Dashboard Datatype.ctl" Type="VI" URL="../TypeDefs/Dashboard Datatype.ctl"/>
			<Item Name="DashboardEnable.ctl" Type="VI" URL="../TypeDefs/DashboardEnable.ctl"/>
			<Item Name="Teleop Mode.ctl" Type="VI" URL="../TypeDefs/Teleop Mode.ctl"/>
			<Item Name="DashboardIndicators.ctl" Type="VI" URL="../TypeDefs/DashboardIndicators.ctl"/>
		</Item>
		<Item Name="Team Code" Type="Folder">
			...
			<Item Name="Build DashBoard Data.vi" Type="VI" URL="../Team Code/Build DashBoard Data.vi"/>
			<Item Name="Shooter RPM Calc.vi" Type="VI" URL="../Team Code/Shooter RPM Calc.vi"/>
		</Item>
		<Item Name="Vision Support Code" Type="Folder"/>
		<Item Name="Support Code" Type="Folder">
			<Item Name="Get Robot Competition Mode.vi" Type="VI" URL="../Support Code/Get Robot Competition Mode.vi"/>
			<Item Name="Elapsed Times.vi" Type="VI" URL="../Support Code/Elapsed Times.vi"/>
		</Item>
		<Item Name="Teleop Modes" Type="Folder">
			<Item Name="Drive Mode.vi" Type="VI" URL="../Drive Mode.vi"/>
		</Item>
		<Item Name="Team Support Code" Type="Folder">
			<Item Name="Arcade Drive Decode.vi" Type="VI" URL="../Team Support Code/Arcade Drive Decode.vi"/>
			<Item Name="Read Ultrasonic.vi" Type="VI" URL="../Team Support Code/Read Ultrasonic.vi"/>
			<Item Name="Decode Shooter Joystick.vi" Type="VI" URL="../Team Support Code/Decode Shooter Joystick.vi"/>
			<Item Name="Boolean Trigger.vi" Type="VI" URL="../Team Support Code/Boolean Trigger.vi"/>
		</Item>
		<Item Name="User Control VIs" Type="Folder">
			<Item Name="Chocolate Station Keep.vi" Type="VI" URL="../User Control VIs/Chocolate Station Keep.vi"/>
			<Item Name="User Bridge Control.vi" Type="VI" URL="../User Control VIs/User Bridge Control.vi"/>
			<Item Name="User Shooter Control.vi" Type="VI" URL="../User Control VIs/User Shooter Control.vi"/>
			<Item Name="Shooter Speed Control.vi" Type="VI" URL="../User Control VIs/Shooter Speed Control.vi"/>
			<Item Name="Kicker and Roller Control.vi" Type="VI" URL="../User Control VIs/Kicker and Roller Control.vi"/>
			<Item Name="User Drivetrain Control.vi" Type="VI" URL="../User Control VIs/User Drivetrain Control.vi"/>
		</Item>
		<Item Name="Autonomous Modes" Type="Folder">
			<Item Name="Two Shots Auto.vi" Type="VI" URL="../Autonomous Modes/Two Shots Auto.vi"/>
			<Item Name="Bridge Lower Auto.vi" Type="VI" URL="../Autonomous Modes/Bridge Lower Auto.vi"/>
			<Item Name="Ball Vomit.vi" Type="VI" URL="../Autonomous Modes/Ball Vomit.vi"/>
			<Item Name="Auto Roller Logic.vi" Type="VI" URL="../Autonomous Modes/Auto Roller Logic.vi"/>
		</Item>
		...
		<Item Name="Build Specifications" Type="Build">
			<Item Name="FRC Robot Boot-up Deployment" Type="{69A947D5-514E-4E75-818E-69657C0547D8}">
				...
				<Property Name="RTExe_localDestPath" Type="Path">../builds/NI_AB_PROJECTNAME/NI_AB_TARGETNAME/FRC Robot Boot-up Deployment</Property>
				<Property Name="Source[0].itemID" Type="Str">{5F6A85C4-DC46-4A88-9018-17E28A4BE683}</Property>
